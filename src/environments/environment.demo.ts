export const environment = {
  production: true,
  urlAPI: 'https://www.back-demo.skooltrak.com/api/',
  meetURL: 'meet.skooltrak.com',
  editorImagesURL:
    'https://www.back-demo.skooltrak.com/api/EditorMedia/Images/',
  editorFilesURL: 'https://www.back-demo.skooltrak.com/api/EditorMedia/Files/',
  editorLinkInfoURL:
  ...
  firebase: {
    ...
    databaseURL: 'https://skooltrak-moises.firebaseio.com',
    projectId: 'skooltrak-moises',
