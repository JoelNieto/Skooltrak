...
@Injectable()
export class PeriodsStore extends ComponentStore<State> implements OnStoreInit {
  private service = inject(PeriodsService);
  ...
  ngrxOnStoreInit = () => this.setState({ periods: [], loading: true });
}
